...
kernel void applyBumpMap(texture2d_array <half, access::read_write> canvas [[texture(0)]],
    ...
    // convert to linear for this step since we're kinda trying to mimic
    // reflectance, not transparency
...
kernel void spectralOver(texture2d_array<half, access::read> src [[texture(0)]],
    ...
    half opacity = srcAndLayerOpacity + dstMeta.x * dstAndLayerOpacity;
